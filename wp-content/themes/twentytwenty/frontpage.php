...
?>
		<section class="banner">
			...
			<ul class="list-unstyled mb-0 list-social">
				...
				<li>
					<a href="<?php the_field('twitter_link') ?>"><i class="twitter-con"></i></a>
				</li>
				<?php } if(get_field('youtube_link') != ''){ ?>
				<li>
					<a href="<?php the_field('youtube_link') ?>"><i class="utube-con"></i></a>
				</li>
				<?php } if(get_field('linkedin_link') != ''){ ?>
				<li>
					<a href="<?php the_field('linkedin_link') ?>"><i class="linkedin-con"></i></a>
				</li>
				<?php } ?>
			</ul>
		</section>
